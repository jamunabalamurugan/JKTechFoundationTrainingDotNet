...
namespace FirsstApplication
{
    class Second
    {
        ...
        static void CalculateTotalAmount()
        {
            ...
            Console.WriteLine("The bill amount {3} net amount is {0} and Tax Amount is {1}  tax% is {2} tax is high? {4}",netAmount,(amount*tax/100),tax,amount,tax>10?"High":"Low");
        ...
        static bool FindPrimeOrNot(int num)//Method declaration
        {
            bool bResult = true;
            for (int i = 2; i < num; i++)
            {
        ...
        static void TakeNumberAndCheckForPrime()
        {
            ...
            bool result = FindPrimeOrNot(iNum);//Calling the method
